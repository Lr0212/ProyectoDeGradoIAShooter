        ...
        if (Physics.Raycast(shootRay, out shootHit, range, shootableMask))
        {
            ...
            if (enemyHealth != null)
            {
                ...
                if (sarsa != null)
                {
                    ...
                    {
                        sarsa.aplicarPuntos((int)CompanionSarsa.Categoria.ELIMINACIONES);
                    }
                    else
                    {
                        sarsa.aplicarPuntos((int)CompanionSarsa.Categoria.PELIGROS);
                    }
                }
                ...
                if (companionEvolutivo !=null)
                {
                    ...
                    sarsa.aplicarCastigo((int)CompanionSarsa.Categoria.PELIGROS);
                }
            }
